...
vercel env rm NETWORK_PASSPHRASE development --yes 2> /dev/null || true
vercel env rm CONTRACT_ID development --yes 2> /dev/null || true
vercel env rm CONTRACT_SECRET development --yes 2> /dev/null || true
vercel env add RPC_URL development < ./contract/.vars/rpc-url
vercel env add NETWORK_PASSPHRASE development < ./contract/.vars/passphrase
vercel env add CONTRACT_ID development < ./contract/.vars/contract-id
vercel env add CONTRACT_SECRET development < ./contract/.vars/secret-key
